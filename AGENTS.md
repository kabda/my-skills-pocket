...
A personal Codex plugin marketplace. Plugins are installed via:
...
2. Update `.Codex-plugin/plugin.json` with real metadata
3. Add skill content to `skills/<skill-name>/SKILL.md`
4. Register the plugin in `.Codex-plugin/marketplace.json` under `plugins[]`
